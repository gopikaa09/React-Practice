...
const Products_123 = () => {
  ...
  const incrementFunction = (productId) => {
    const newProducts = updateProductList.map((product) => {
  ...
  const decrementFunction = (productId) => {
    const newProducts = updateProductList.map((product) => {
    ...
    <div className={style.maincard}>
      {
        ...
        <div className={style.cards} key={product.id}>
          ...
          <br />
          <button onClick={() => incrementFunction(product.id)}>+</button>
          <span>{product.count}</span>
          <button onClick={() => decrementFunction(product.id)}>-</button>
        </div>
      ))
    }
    </div>
